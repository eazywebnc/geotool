const ecosystemProducts = [
    { label: "ReviewAnalyzer", href: "https://reviewanalyzer.eazyweb.nc", desc: "Review intelligence" },
    { label: "OGMagic", href: "https://ogmagic.eazyweb.nc", desc: "OG images" },
    { label: "RepurposeBot", href: "https://repurposebot.eazyweb.nc", desc: "Content repurposing" },
];
